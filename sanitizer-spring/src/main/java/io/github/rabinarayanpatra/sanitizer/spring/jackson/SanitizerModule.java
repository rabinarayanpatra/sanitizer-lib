...
public final class SanitizerModule extends SimpleModule {
  ...
  /**
   * Creates a new instance of the {@code SanitizerModule}, registering a custom deserializer modifier that applies
   * sanitization logic to deserialized beans.
   */
  ...
  /**
   * Delegating deserializer that applies {@link SanitizationUtils} after the default deserialization process.
   */
  private static class SanitizingDeserializer extends DelegatingDeserializer {

    /**
     * Constructs a new {@code SanitizingDeserializer} that delegates to the given deserializer.
     *
     * @param delegate the original deserializer to wrap
     */
    ...
    /**
     * Deserializes the input and then applies sanitization logic to the resulting object.
     *
    ...
    /**
     * Creates a new delegating instance wrapping a different underlying deserializer.
     *
     * @param newDelegate the new delegate to use
