 ...
 * <p>
 * This exception typically occurs when the sanitizer class lacks a no-arg constructor, or the constructor is not
...
public class SanitizerInstantiationException extends RuntimeException {
  ...
  /**
   * Constructs a new {@code SanitizerInstantiationException} with the specified detail message and cause.
   *
   * @param message the detail message explaining the failure
   * @param cause   the underlying exception that caused instantiation to fail
   */
