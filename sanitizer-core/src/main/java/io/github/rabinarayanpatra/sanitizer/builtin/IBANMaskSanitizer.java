 ...
 * <p>
 * All whitespace is removed before masking. The result is a masked string of
 * asterisks followed by the last four characters of the IBAN, helping protect
 * sensitive account details while retaining partial traceability.
 *
 * <pre>
 * {@code
...
public class IBANMaskSanitizer implements FieldSanitizer<String> {
	 ...
	 * Default constructor.
	 */
	public IBANMaskSanitizer() {
	}

	/**
	 * Masks all but the last four characters of an IBAN, removing whitespace before
	 * processing.
	 *
	 * @param in
