 ...
 * <p>
 * Non-digit characters are removed before masking. If the cleaned input does not contain exactly 9 digits, the original
...
public class SSNMaskSanitizer implements FieldSanitizer<String> {
   ...
   *
   * @param in the input SSN string
   * @return the masked SSN, or the original input if the cleaned string is not 9 digits; {@code null} if input is null
   */
  @Override
